...
def get_best_estimators(classification):
    ...
    if classification:
        return pickle.load(
            open("C:\\Users\\Andras\\Desktop\\work\\MASZ\\SER-SpeechMaster\\grid\\best_classifiers.pickle", "rb"))
    else:
        return pickle.load(
            open("C:\\Users\\Andras\\Desktop\\work\\MASZ\\SER-SpeechMaster\\grid\\best_regressors.pickle", "rb"))
