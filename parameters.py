...
ROOT_DIR = os.path.dirname(os.path.abspath(__file__))  # C:\Users\Andras\Desktop\work\MASZ\SER-SpeechMaster

classification_grid_parameters = {
    # SVC(): {
        # 'C': [0.002, 0.01, 0.1, 1, 10],
        # 'C': [0.1],
        # 'gamma': [0.001, 0.1, 1],
        # 'gamma': [0.1],
    ...
    RandomForestClassifier(): {
        ...
        'max_depth': [3, 5, 7],
        'min_samples_split': [0.3, 0.7, 2],
        'min_samples_leaf': [0.3, 1, 2],
        'max_features': [0.4, 1, 2],
    },
